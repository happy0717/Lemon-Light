...
<template>
  <section class="tab">
    ...
    <div class="card">
      ...
      <p class="mode-desc">开启后每日 9:15 集合竞价开始即展示，11:35 后隐藏，12:55 提前展示；收盘后 30 分钟内保持显示尾盘价，其余休市时段自动隐藏。</p>
    ...
    <div class="card">
      ...
      <p class="tip">长按悬浮球即可拖动位置，松开后自动记忆；单击悬浮球展开完整面板，移开后自动收起。休市自动隐藏开启后，自选覆盖的市场全部休市（含午休与周末）时悬浮球自动隐藏；每日 9:15 集合竞价开始即提前展示以观察竞价/开盘价，11:35 后隐藏，12:55 再次提前展示，收盘后 30 分钟内保持显示尾盘价。面板背景色只作用于展开面板，与底部横幅配色相互独立。</p>
    </div>
